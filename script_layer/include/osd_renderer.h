...
{
public:
	osd_rect(int16_t x, int16_t y, int16_t w, int16_t h, uint32_t strokeColour, uint32_t fillColour) : _x(x), _y{y}, _w{static_cast<uint16_t>(w)}, _h{static_cast<uint16_t>(h)}, _strokeColour{strokeColour}, _fillColour{fillColour} {}
