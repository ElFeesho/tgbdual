    ...
    while (!feof(file)) {
        if (!fgets(buf, 256, file)) {
            ...
            if (first) {
                ...
                tmp->code =
                    (isalpha(buf[0]) ? (buf[0] - 'A' + 10) : (buf[0] - '0')) * 16 +
                    (isalpha(buf[1]) ? (buf[1] - 'A' + 10) : (buf[1] - '0'));
                tmp->adr =
                    (isalpha(buf[4]) ? (buf[4] - 'A' + 10) : (buf[4] - '0')) * 16 +
                    (isalpha(buf[5]) ? (buf[5] - 'A' + 10) : (buf[5] - '0')) +
                    (isalpha(buf[6]) ? (buf[6] - 'A' + 10) : (buf[6] - '0')) * 4096 +
                    (isalpha(buf[7]) ? (buf[7] - 'A' + 10) : (buf[7] - '0')) * 256;
                tmp->dat =
                    (isalpha(buf[2]) ? (buf[2] - 'A' + 10) : (buf[2] - '0')) * 16 +
                    (isalpha(buf[3]) ? (buf[3] - 'A' + 10) : (buf[3] - '0'));
                req = true;
                ready = true;
            }
        }
